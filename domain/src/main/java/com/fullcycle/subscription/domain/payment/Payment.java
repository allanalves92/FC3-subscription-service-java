...
public sealed interface Payment extends AssertionConcern permits PixPayment, CreditCardPayment {
    ...
    static Payment create(final String type, final String orderId, final Double amount, final BillingAddress address,
                          final String token) {
        return switch (type) {
