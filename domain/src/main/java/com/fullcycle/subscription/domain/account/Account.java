...
import static com.fullcycle.subscription.domain.account.AccountCommand.ChangeDocumentCommand;
import static com.fullcycle.subscription.domain.account.AccountCommand.ChangeEmailCommand;
import static com.fullcycle.subscription.domain.account.AccountCommand.ChangeProfileCommand;
import static com.fullcycle.subscription.domain.account.AccountEvent.*;
