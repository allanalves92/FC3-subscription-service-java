...
class DocumentTest {
    ...
    public void givenInvalidCpfLength_whenInstantiate_shouldReturnError() {
        ...
        // when
        var actualError =
                assertThrows(DomainException.class, () -> Document.create(expectedDocumentValue, expectedDocumentType));
    ...
    public void givenNullCnpj_whenInstantiate_shouldReturnError() {
        ...
        var actualError = assertThrows(
                DomainException.class, () -> Document.create(expectedDocumentValue, expectedDocumentType));
