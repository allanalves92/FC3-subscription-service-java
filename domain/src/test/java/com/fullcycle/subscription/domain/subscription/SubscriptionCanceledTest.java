...
class SubscriptionCanceledTest {
    ...
    public void givenValidSubscription_whenInstantiate_shouldReturnEvent() {
        ...
        var expectedSubscription =
                Subscription.newSubscription(new SubscriptionId("SUB"), new AccountId("ACC123"), Fixture.Plans.plus());
    ...
    public void givenNullSubscriptionId_whenInstantiate_shouldReturnError() {
        ...
        var actualError = assertThrows(
                ...
                () -> new SubscriptionCanceled(expectedSubscriptionId, expectedAccountId, expectedPlanId,
                        expectedDueDate, expectedOccurredOn)
        );
